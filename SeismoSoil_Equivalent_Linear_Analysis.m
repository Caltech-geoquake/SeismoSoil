function varargout = SeismoSoil_Equivalent_Linear_Analysis(varargin)
% SEISMOSOIL_EQUIVALENT_LINEAR_ANALYSIS MATLAB code for SeismoSoil_Equivalent_Linear_Analysis.fig
%      SEISMOSOIL_EQUIVALENT_LINEAR_ANALYSIS, by itself, creates a new SEISMOSOIL_EQUIVALENT_LINEAR_ANALYSIS or raises the existing
%      singleton*.
%
%      H = SEISMOSOIL_EQUIVALENT_LINEAR_ANALYSIS returns the handle to a new SEISMOSOIL_EQUIVALENT_LINEAR_ANALYSIS or the handle to
%      the existing singleton*.
%
%      SEISMOSOIL_EQUIVALENT_LINEAR_ANALYSIS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEISMOSOIL_EQUIVALENT_LINEAR_ANALYSIS.M with the given input arguments.
%
%      SEISMOSOIL_EQUIVALENT_LINEAR_ANALYSIS('Property','Value',...) creates a new SEISMOSOIL_EQUIVALENT_LINEAR_ANALYSIS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SeismoSoil_Equivalent_Linear_Analysis_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SeismoSoil_Equivalent_Linear_Analysis_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @SeismoSoil_Equivalent_Linear_Analysis_OpeningFcn, ...
                   'gui_OutputFcn',  @SeismoSoil_Equivalent_Linear_Analysis_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SeismoSoil_Equivalent_Linear_Analysis is made visible.
function SeismoSoil_Equivalent_Linear_Analysis_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes SeismoSoil_Equivalent_Linear_Analysis wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SeismoSoil_Equivalent_Linear_Analysis_OutputFcn(hObject, eventdata, handles) 
...
if isequal(profile_file_name,0)
    ...
    folder_name = sprintf('%s_Equivalent_Linear_Analysis_Results',sitecode_);
...
close SeismoSoil_Equivalent_Linear_Analysis;
SeismoSoil;
