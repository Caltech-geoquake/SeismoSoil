function varargout = SeismoSoil_Tools_Signal_Filters(varargin)
% SEISMOSOIL_TOOLS_SIGNAL_FILTERS M-file for SeismoSoil_Tools_Signal_Filters.fig
%      SEISMOSOIL_TOOLS_SIGNAL_FILTERS, by itself, creates a new SEISMOSOIL_TOOLS_SIGNAL_FILTERS or raises the existing
%      singleton*.
%
%      H = SEISMOSOIL_TOOLS_SIGNAL_FILTERS returns the handle to a new SEISMOSOIL_TOOLS_SIGNAL_FILTERS or the handle to
%      the existing singleton*.
%
%      SEISMOSOIL_TOOLS_SIGNAL_FILTERS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEISMOSOIL_TOOLS_SIGNAL_FILTERS.M with the given input arguments.
%
%      SEISMOSOIL_TOOLS_SIGNAL_FILTERS('Property','Value',...) creates a new SEISMOSOIL_TOOLS_SIGNAL_FILTERS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SeismoSoil_Tools_Signal_Filters_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SeismoSoil_Tools_Signal_Filters_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SeismoSoil_Tools_Signal_Filters

% Last Modified by GUIDE v2.5 24-Aug-2014 23:45:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SeismoSoil_Tools_Signal_Filters_OpeningFcn, ...
                   'gui_OutputFcn',  @SeismoSoil_Tools_Signal_Filters_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SeismoSoil_Tools_Signal_Filters is made visible.
function SeismoSoil_Tools_Signal_Filters_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SeismoSoil_Tools_Signal_Filters (see VARARGIN)

% Choose default command line output for SeismoSoil_Tools_Signal_Filters
...
% UIWAIT makes SeismoSoil_Tools_Signal_Filters wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SeismoSoil_Tools_Signal_Filters_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes during object creation, after setting all properties.
function uipanel8_filter_type_CreateFcn(hObject, eventdata, handles)
% hObject    handle to uipanel8_filter_type (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

filter_type = 'highpass';
handles.metricdata.filter_type = filter_type;
guidata(hObject,handles);


% --- Executes when selected object is changed in uipanel8_filter_type.
function uipanel8_filter_type_SelectionChangeFcn(hObject, eventdata, handles)
% hObject    handle to the selected object in uipanel8_filter_type 
% eventdata  structure with the following fields (see UIBUTTONGROUP)
%	EventName: string 'SelectionChanged' (read only)
%	OldValue: handle of the previously selected object or empty if none was selected
%	NewValue: handle of the currently selected object
...
switch get(eventdata.NewValue,'Tag') % Get Tag of selected object.
    case 'radiobutton2a'
        filter_type = 'highpass';
        set(handles.metricdata.fc_low_handle,'enable','on');
        set(handles.metricdata.fc_high_handle,'enable','off');
    case 'radiobutton2b'
        filter_type = 'lowpass';
        set(handles.metricdata.fc_low_handle,'enable','off');
        set(handles.metricdata.fc_high_handle,'enable','on');
    case 'radiobutton2c'
...
% --- Executes during object creation, after setting all properties.
function edit1_cutoff_freq_low_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit1_cutoff_freq_low (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
fc_low = str2double(get(hObject,'String'));  % default = 0.2 Hz
handles.metricdata.fc_low = fc_low;
handles.metricdata.fc_low_handle = hObject;

guidata(hObject,handles);



function edit1_cutoff_freq_low_Callback(hObject, eventdata, handles)
% hObject    handle to edit1_cutoff_freq_low (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit1_cutoff_freq_low as text
%        str2double(get(hObject,'String')) returns contents of edit1_cutoff_freq_low as a double

fc_low = str2double(get(hObject,'String'));
handles.metricdata.fc_low = fc_low;
guidata(hObject,handles);
...
fc_high = str2double(get(hObject,'String')); % default = 30 Hz
handles.metricdata.fc_high = fc_high;
handles.metricdata.fc_high_handle = hObject;

guidata(hObject,handles);

    
function edit3_cutoff_freq_high_Callback(hObject, eventdata, handles)
% hObject    handle to edit3_cutoff_freq_high (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit3_cutoff_freq_high as text
%        str2double(get(hObject,'String')) returns contents of edit3_cutoff_freq_high as a double

fc_high = str2double(get(hObject,'String'));
handles.metricdata.fc_high = fc_high;
guidata(hObject,handles);
...
% --- Executes on button press in pushbutton3_filter_all.
function pushbutton3_filter_all_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton3_filter_all (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
if handles.metricdata.step4_complete == 0
    ...
    fc_low = handles.metricdata.fc_low;
    fc_high = handles.metricdata.fc_high;
    plot_option = 1;
    ...
    for i = 1 : 1 : nr_motion
        ...
        % * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
        switch handles.metricdata.filter_type
            case 'highpass'
                result = zeroPhaseHighPass(current_motion,fc_low,plot_option,4,x_axis_scale);
            case 'lowpass'
                result = zeroPhaseLowPass(current_motion,fc_high,plot_option,4,x_axis_scale);
            case 'bandpass'
                result = zeroPhaseBandPass(current_motion,fc_low,fc_high,plot_option,4,x_axis_scale);
            case 'bandstop'
                result = zeroPhaseBandStop(current_motion,fc_low,fc_high,plot_option,4,x_axis_scale);
        end
        new_title_text = sprintf('%s\nComparison',current_motion_filename);
        title(new_title_text,'interpreter','none','fontsize',14);
        % * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    end
...
% --- Executes on button press in pushbutton4_filter_selected.
function pushbutton4_filter_selected_Callback(hObject, eventdata, handles)
...
% --- Executes on button press in pushbutton5_filter_all_and_save.
function pushbutton5_filter_all_and_save_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton5_filter_all_and_save (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
if handles.metricdata.step4_complete == 0
    ...
    for i = 1 : 1 : nr_motion
        ...
        % * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
        filter_type = handles.metricdata.filter_type;
        switch filter_type
            case 'highpass'
                result = zeroPhaseHighPass(current_motion,fc_low,plot_option,4,x_axis_scale);
            case 'lowpass'
        ...
        result_filename = sprintf('%s_%s_filtered%s',motion_fname_without_ext,filter_type,ext);
...
function pushbutton6_filter_selected_and_save_Callback(hObject, eventdata, handles)
...
% --- Executes on button press in checkbox1_highpass.
function checkbox1_highpass_Callback(hObject, eventdata, handles)
% hObject    handle to checkbox1_highpass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkbox1_highpass

high_pass = get(hObject,'Value');
handles.metricdata.high_pass = high_pass;
guidata(hObject,handles);



% --- Executes during object creation, after setting all properties.
function checkbox1_highpass_CreateFcn(hObject, eventdata, handles)
% hObject    handle to checkbox1_highpass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in checkbox2_low_pass.
function checkbox2_low_pass_Callback(hObject, eventdata, handles)
% hObject    handle to checkbox2_low_pass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkbox2_low_pass

low_pass = get(hObject,'Value');
handles.metricdata.low_pass = low_pass;
guidata(hObject,handles);


% --- Executes during object creation, after setting all properties.
function checkbox2_low_pass_CreateFcn(hObject, eventdata, handles)
% hObject    handle to checkbox2_low_pass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
