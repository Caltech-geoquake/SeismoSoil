function varargout = SeismoSoil_Tools_Motion_Unit_Converter(varargin)
% SEISMOSOIL_TOOLS_MOTION_UNIT_CONVERTER M-file for SeismoSoil_Tools_Motion_Unit_Converter.fig
%      SEISMOSOIL_TOOLS_MOTION_UNIT_CONVERTER, by itself, creates a new SEISMOSOIL_TOOLS_MOTION_UNIT_CONVERTER or raises the existing
%      singleton*.
%
%      H = SEISMOSOIL_TOOLS_MOTION_UNIT_CONVERTER returns the handle to a new SEISMOSOIL_TOOLS_MOTION_UNIT_CONVERTER or the handle to
%      the existing singleton*.
%
%      SEISMOSOIL_TOOLS_MOTION_UNIT_CONVERTER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEISMOSOIL_TOOLS_MOTION_UNIT_CONVERTER.M with the given input arguments.
%
%      SEISMOSOIL_TOOLS_MOTION_UNIT_CONVERTER('Property','Value',...) creates a new SEISMOSOIL_TOOLS_MOTION_UNIT_CONVERTER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SeismoSoil_Tools_Motion_Unit_Converter_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SeismoSoil_Tools_Motion_Unit_Converter_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SeismoSoil_Tools_Motion_Unit_Converter

% Last Modified by GUIDE v2.5 24-Aug-2014 23:44:25

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SeismoSoil_Tools_Motion_Unit_Converter_OpeningFcn, ...
                   'gui_OutputFcn',  @SeismoSoil_Tools_Motion_Unit_Converter_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SeismoSoil_Tools_Motion_Unit_Converter is made visible.
function SeismoSoil_Tools_Motion_Unit_Converter_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SeismoSoil_Tools_Motion_Unit_Converter (see VARARGIN)

% Choose default command line output for SeismoSoil_Tools_Motion_Unit_Converter
...
% UIWAIT makes SeismoSoil_Tools_Motion_Unit_Converter wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SeismoSoil_Tools_Motion_Unit_Converter_OutputFcn(hObject, eventdata, handles) 
...
handles.metricdata.factor_to_SI = factor_to_SI;
guidata(hObject,handles);
