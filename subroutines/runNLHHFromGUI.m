function [ok_to_proceed,h_running] = runNLHHFromGUI(vs_profile,curve,H4G,H4x,...
...
if ok_to_proceed == 1
    ...
    %for ii = 1 : nr_motion
        ...
        [layer_depth,node_depth,out_a,out_v,out_d,out_gamma,out_tau] = ...
            resp_NLHH(f_max,ppw,n_dt,boundary,N_spr,accel_in,...
...
function [ layer_depth, node_depth, out_a, out_v, out_d, out_gamma, out_tau ] = ...
    resp_NLHH(f_max, ppw, n_dt, boundary, N_spr, acc, vs_profile, curve, para_G, para_x, dir_H4, use_fortran )
