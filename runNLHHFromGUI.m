function [ok_to_proceed,h_running] = runNLHHFromGUI(profile,curve,H4G,H4x,...
...
function [ layer_depth, node_depth, out_a, out_v, out_d, out_gamma, out_tau ] = ...
    resp_NLHH(f_max, ppw, n_dt, boundary, N_spr, acc, profile, curve, para_G, para_x, dir_H4, use_fortran )
